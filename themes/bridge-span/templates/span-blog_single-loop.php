...
$bridge_qode_blog_hide_comments = "true";
...
<?php 
	...
	if ($toppic) {
		$topimgurl = wp_get_attachment_image_url( $toppic, 'full' ); 
	} else if ( has_post_thumbnail() ) { 
		$topimgurl = get_the_post_thumbnail_url(null, 'full');	
	} 
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="post_content_holder">
		<div class="post_text">
			<div class="post_text_inner">
				<div class="vc_row wpb_row section vc_row-fluid  bigheads darkstripe" 
					style='background-image:  url(<?= $topimgurl ?>);background-size: cover; text-align:left;'>
